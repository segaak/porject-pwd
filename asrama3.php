...
if (isset($_POST["tambah"])) {
    ...
    if (!isset($_SESSION["login"])) {
      ...
      exit;
        ...
        document.location.href = 'asrama3.php';
        </script>";
      } else {
          echo "<script>
...
$pesan = query("select nama, catatan, jumlah from donasi where tujuan = 'asrama3'");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="content">
        ...
        <div class="form-group">
                ...
                <label for="tujuan" class="col-sm-2 col-form-label text-start form-label">Tujuan</label>
                        ...
                        <input type="text" class="form-control" id="tujuan" name="tujuan" value="asrama3" readonly>
